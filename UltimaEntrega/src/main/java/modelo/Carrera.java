...
@NamedQueries(value = {
		...
		@NamedQuery(name = Carrera.BUSCAR_CON_INSCRIPTOS, query = "SELECT  DISTINCT i.carrera FROM Inscripcion i,  Estudiante e, Carrera c WHERE c.idCarrera = i.carrera.idCarrera AND e.LU = i.estudiante.LU GROUP BY i.carrera.idCarrera ORDER BY COUNT(i.estudiante) DESC"),
...
public class Carrera {
	...
	@JsonManagedReference(value="inscripcion-carrera")
